...
class _SignUpPageWidgetState extends State<SignUpPageWidget> {
  ...
  void initState() {
    ...
    _model.contactInputTextController ??= TextEditingController();
    _model.contactInputFocusNode ??= FocusNode();
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.contactInputTextController,
                                      focusNode: _model.contactInputFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                                      ...
                                      cursorColor: FlutterFlowTheme.of(context)
                                          .primaryText,
                                      validator: _model
                                          .contactInputTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
